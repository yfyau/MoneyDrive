...
public class CurrencyHelper
{
     ...
     */
    private static final String[] MAIN_CURRENCIES = {"USD", "EUR", "GBP", "IRN", "AUD", "CAD", "SGD", "CHF", "MYR", "JPY", "CNY", "NZD", "HKD"};
...
// ----------------------------------------->
    ...
    {
        Log.d("Currency",  "Currency = " + Parameters.getInstance(context).getString(ParameterKeys.CURRENCY_ISO));
